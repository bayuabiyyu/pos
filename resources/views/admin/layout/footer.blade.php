<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="#">Ahmad Husain Abiyyu</a></strong> All rights reserved.
  </footer>
...
<!-- jQuery UI 1.11.4 -->
<script src="{{ asset('assets/admin-lte') }}/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<!-- Morris.js charts -->
<script src="{{ asset('assets/admin-lte') }}/bower_components/raphael/raphael.min.js"></script>
<script src="{{ asset('assets/admin-lte') }}/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
<script src="{{ asset('assets/admin-lte') }}/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="{{ asset('assets/admin-lte') }}/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
